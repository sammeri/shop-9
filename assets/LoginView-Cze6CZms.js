...
`,gt={root:"p-chip p-component",image:"p-chip-image",icon:"p-chip-icon",label:"p-chip-label",removeIcon:"p-chip-remove-icon"},yt=de.extend({name:"chip",style:vt,classes:gt}),bt={name:"BaseChip",extends:Ae,props:{label:{type:[String,Number],default:null},icon:{type:String,default:null},image:{type:String,default:null},removable:{type:Boolean,default:!1},removeIcon:{type:String,default:void 0}},style:yt,provide:function(){return{$pcChip:this,$parentInstance:this}}},He={name:"Chip",extends:bt,inheritAttrs:!1,emits:["remove"],data:function(){return{visible:!0}},methods:{onKeydown:function(e){(e.key==="Enter"||e.key==="Backspace")&&this.close(e)},close:function(e){this.visible=!1,this.$emit("remove",e)}},computed:{dataP:function(){return H({removable:this.removable})}},components:{TimesCircleIcon:Fe}},wt=["aria-label","data-p"],Ot=["src"];function It(t,e,n,o,r,i){return r.visible?(p(),v("div",c({key:0,class:t.cx("root"),"aria-label":t.label},t.ptmi("root"),{"data-p":i.dataP}),[b(t.$slots,"default",{},function(){return[t.image?(p(),v("img",c({key:0,src:t.image},t.ptm("image"),{class:t.cx("image")}),null,16,Ot)):t.$slots.icon?(p(),F(_(t.$slots.icon),c({key:1,class:t.cx("icon")},t.ptm("icon")),null,16,["class"])):t.icon?(p(),v("span",c({key:2,class:[t.cx("icon"),t.icon]},t.ptm("icon")),null,16)):S("",!0),t.label!==null?(p(),v("div",c({key:3,class:t.cx("label")},t.ptm("label")),K(t.label),17)):S("",!0)]}),t.removable?b(t.$slots,"removeicon",{key:0,removeCallback:i.close,keydownCallback:i.onKeydown},function(){return[(p(),F(_(t.removeIcon?"span":"TimesCircleIcon"),c({class:[t.cx("removeIcon"),t.removeIcon],onClick:i.close,onKeydown:i.onKeydown},t.ptm("removeIcon")),null,16,["class","onClick","onKeydown"]))]}):S("",!0)],16,wt)):S("",!0)}He.render=It;var Ne=Xe(),St=`
